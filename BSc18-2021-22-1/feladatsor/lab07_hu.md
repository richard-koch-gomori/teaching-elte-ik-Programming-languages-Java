# Programozási nyelvek (BSc, 18) Java 7. feladatsor
...
(a hatvány alap és kitevő is termászetes szám). Bár az eredmény mindig egész lesz,
...
Tesztelje le a **3. feladatsor 1/b. feladatának** megoldását JUnit segítségével! Ehhez szükség lesz a beolvasó, összegző, valamint kiíró logika szétválasztására. Ezeket rendezze statikus metódusokba, úgy, hogy ne függjenek egymástól, csupán a paraméterek/visszatérési érték segítségével tudjanak kommunikálni egymással!
