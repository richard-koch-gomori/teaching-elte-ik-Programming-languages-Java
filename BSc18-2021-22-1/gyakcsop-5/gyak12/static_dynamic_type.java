...
class Main
{
    ...
    {
        // book változó:
        // statikus (deklarált) típus: Book
        // dinamikus típus: PrintedBook
        Book book = new PrintedBook("author", "title", 100, CoverType.Softcover);
        System.out.println(book.createReference("article", 20, 24));
    }
}
...
A szülő helyettesíthető a gyerekével.
