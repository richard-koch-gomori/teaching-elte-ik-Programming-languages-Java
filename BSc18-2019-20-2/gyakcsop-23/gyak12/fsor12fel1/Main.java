...
class Vector implements Comparable<Vector>
{
    ...
    */
    ...
    // a példa eredménye: [(6,2), (2,3), (-2,3), (4,8), (5,8), (5,4), (10,6)]
    // pl (4,8), (5,8) jó sorrendben van, de a matematikai részbenrendezéssel pl a (6,2) és (4,8) nem hasonlítható össze
    */
}
...
class Main
{
    public static void main(String[] args)
    {
        ...
        */
        ...
        list.add(new Vector(5, 8));
        list.add(new Vector(5, 4));
        list.add(new Vector(-2, 3));
        list.add(new Vector(10, 6));
